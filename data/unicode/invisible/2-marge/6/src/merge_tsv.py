...
import sys
import argparse
from help.merge_tsv_param import HELP_CATE_WHITE, HELP_CATE_BLACK, HELP_ADD_LIST, HELP_BAN_LIST, HELP_OFF_CATE
...
def main():
    ...
    parser.add_argument('--cate-white', help=HELP_CATE_WHITE)
    parser.add_argument('--cate-black', help=HELP_CATE_BLACK)
    parser.add_argument('--add-list', help=HELP_ADD_LIST)
    parser.add_argument('--ban-list', help=HELP_BAN_LIST)
    parser.add_argument('--off-cate', action='store_true', help=HELP_OFF_CATE)
